...
int main() {
	...
	while(dataInput) {
		...
		if(elf2Sector[0] >= elf1Sector[0] && elf2Sector[0] <= elf1Sector[1]) {
			overlap += 1;
		}
		else if (elf2Sector[1] <= elf1Sector[1] && elf2Sector[1] >= elf1Sector[0]) {
			overlap += 1;
		}	
		else if (elf1Sector[0] >= elf2Sector[0] && elf1Sector[0] <= elf2Sector[1]) {
			overlap += 1;
		}
		else if (elf1Sector[1] <= elf2Sector[1] && elf1Sector[1] >= elf2Sector[0]) {
			overlap += 1;
		}
	}
